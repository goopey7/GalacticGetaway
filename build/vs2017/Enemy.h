...
{
public:
	void Init(float size_x, float size_y, float size_z, float pos_x, float pos_y, b2World* world, PrimitiveBuilder* builder, const gef::Platform* platform, const ::Player* player);
	void Init(gef::Vector4 size, gef::Vector4 pos, b2World* world, PrimitiveBuilder* builder, const gef::Platform* platform, const ::Player* player);
